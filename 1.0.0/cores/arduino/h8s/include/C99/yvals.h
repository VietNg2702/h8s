...
typedef unsigned int _Sizet;
 ...
 #if !defined(_HAS_C9X) && defined(__H8__) /* change _C99 */
  #define _HAS_C9X	1
...
#if defined(__H8__) && defined(_R_NO_WIDECHAR)	/* V10000K101 */
 /* Dummy */
#else
 #ifdef __cplusplus
  #define _WCHART
